...
postBuild libName PostBuildComponentInputs{..} = do
  ...
  forM_ swiftMods $ \(path, modl) -> do
    ...
    B.writeFile path . (<> contents) $ B.unlines $ map B.pack
      ...
      , ""
      , "import Foundation"
      , "import ForeignHaskell" -- all foreign exports are here
      , ""
  ...
  let modMapPath = haskellSourcesDir </> "module.modulemap"

  -- all foreign export headers are "folded" into the "ForeignHaskell" module
  B.writeFile modMapPath $ B.unlines $ map B.pack
    [ "// This file is automatically generated by swift-ffi"
    , "// Do not edit this file directly!"
    , ""
    , "module ForeignHaskell {"
    , "    umbrella \"include\""
    , ""
    , "    explicit module * {"
    , "        export *"
